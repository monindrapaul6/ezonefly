...
<head>
    ...
    <title>Ezonefly - Multipurpose eCommerce Bootstrap5 Template</title>
                                ...
                                <div class="col-lg-4 col-md-6 text-center text-md-start">
                                    ...
                                    <div class="header-top-social-links">
                                        ...
                                        <ul class="social-link-small">
                                            ...
                                            <li><a href="http://www.youtube.com/"><i class="ion-social-youtube"></i></a>
                                            </li>
                                        </ul>
                        ...
                        <div class="navigation-top-search-area pt-25 pb-25">
                            <div class="row align-items-center">
                                <div class="col-6 col-xl-2 col-lg-3 order-1 col-md-6 col-sm-5">
                                    ...
                                    <div class="logo">
                                        <a href="index.html">
                                            <img width="580" height="auto" src="assets/img/ezone-logo.png" class="img-fluid"
                                                alt="">
                                        </a>
                                    </div>
                                ...
                                <div
                                    ...
                                    <div class="customer-support-text">
                                        <div class="icon">
                                            <img width="39" height="35" src="assets/img/icons/icon-header-phone.webp"
                                                class="img-fluid" alt="">
                                        </div>
