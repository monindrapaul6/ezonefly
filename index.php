                    ...
                    <div class="icon-feature-wrapper">
                        <div class="row row-5">
                            <div class="col-6 col-lg-3 col-sm-6">
                                ...
                                <div class="single-icon-feature">
                                    <div class="single-icon-feature__icon">
                                        <img width="59" height="38" src="assets/img/icons/free_shipping.webp" class="img-fluid" alt="">
                                    </div>
                            ...
                            <div class="col-6 col-lg-3 col-sm-6">
                                ...
                                <div class="single-icon-feature">
                                    <div class="single-icon-feature__icon">
                                        <img width="53" height="40" src="assets/img/icons/support247.webp" class="img-fluid" alt="">
                                    </div>
                                    <div class="single-icon-feature__content">
                            ...
                            <div class="col-6 col-lg-3 col-sm-6">
                                ...
                                <div class="single-icon-feature">
                                    <div class="single-icon-feature__icon">
                                        <img width="52" height="40" src="assets/img/icons/moneyback.webp" class="img-fluid" alt="">
                                    </div>
                                    <div class="single-icon-feature__content">
                            ...
                            <div class="col-6 col-lg-3 col-sm-6">
                                ...
                                <div class="single-icon-feature">
                                    <div class="single-icon-feature__icon">
                                        <img width="58" height="39" src="assets/img/icons/payment_secure.webp" class="img-fluid" alt="">
                                    </div>
                                    <div class="single-icon-feature__content">
                        ...
                        <div class="ht-slick-slider" data-slick-setting='{
                            ...
                            <div class="single-category-item">
                                <div class="single-category-item__image">
                                    <a href="shop-left-sidebar.html">
                                        <img width="262" height="340" src="assets/img/category/cat1.webp" class="img-fluid" alt="">
                                    </a>
                            ...
                            <div class="single-category-item">
                                <div class="single-category-item__image">
                                    <a href="shop-left-sidebar.html">
                                        <img width="262" height="340" src="assets/img/category/cat2.webp" class="img-fluid" alt="">
                                    </a>
                                    <div class="single-category-item__image__content">
                                        <h5 class="category-title"><a href="shop-left-sidebar.html">HOUSE PLANTS</a>
                                        </h5>
                            ...
                            <div class="single-category-item">
                                <div class="single-category-item__image">
                                    <a href="shop-left-sidebar.html">
                                        <img width="262" height="340" src="assets/img/category/cat3.webp" class="img-fluid" alt="">
                                    </a>
                                    <div class="single-category-item__image__content">
                            ...
                            <div class="single-category-item">
                                <div class="single-category-item__image">
                                    <a href="shop-left-sidebar.html">
                                        <img width="262" height="340" src="assets/img/category/cat4.webp" class="img-fluid" alt="">
                                    </a>
                                    <div class="single-category-item__image__content">
                                        <h5 class="category-title"><a href="shop-left-sidebar.html">PLANT FOR GIFT</a>
                                        </h5>
                        ...
                        <div class="ht-slick-slider" data-slick-setting='{
                            ...
                            <div class="single-slider-product-wrapper">
                                <div class="single-slider-product">
                                    ...
                                    <div class="single-slider-product__content">
                                        ...
                                        <p class="product-title"><a href="single-product.html">Lorem ipsum garden
                                                tools</a></p>
                                        <div class="rating">
                                            <i class="ion-android-star active"></i>
                                            <i class="ion-android-star active"></i>
                                ...
                                <div class="single-slider-product">
                                    <div class="single-slider-product__image">
                                        <a href="single-product.html">
                                            ...
                                            <img width="600" height="600" src="assets/img/products/medium15.webp" class="img-fluid" alt="">
                                        </a>
                                    ...
                                    <div class="single-slider-product__content">
                                        ...
                                        <p class="product-price"><span class="discounted-price">$30.00</span> <span
                                                class="main-price discounted">$50.00</span></p>
                            ...
                            <div class="single-slider-product-wrapper">
                                <div class="single-slider-product">
                                    <div class="single-slider-product__image">
                                        <a href="single-product.html">
                                            <img width="600" height="600" src="assets/img/products/medium16.webp" class="img-fluid" alt="">
                                            <img width="600" height="600" src="assets/img/products/medium17.webp" class="img-fluid" alt="">
                                        </a>
            ...
            <div class="row align-items-center">
                <div class="col-xl-4 col-lg-5 mb-md-30 mb-sm-30">
                    ...
                    <div class="full-banner__content">
                        ...
                        <a href="shop-left-sidebar.html"
                            class="theme-button theme-button--outline banner-button">Explore The Shop</a>
                    </div>
                ...
                <div class="col-xl-8 col-lg-7 text-center text-lg-end mb-md-30 mb-sm-30">
                    ...
                    <div class="full-banner__image">
                        <a href="shop-left-sidebar.html">
                            <img width="694" height="424" src="assets/img/banners/banner-big1.webp" class="img-fluid" alt="">
                        </a>
                    </div>
            ...
            <div class="row row-10">
                <div class="col-custom-5 mb-sm-30">
                    ...
                    <div class="slider-banner">
                        <a href="shop-left-sidebar.html">
                            <img width="432" height="694" src="assets/img/banners/slider-banner1.webp" class="img-fluid" alt="">
                        </a>
                    </div>
                    ...
                    <div class="brand-logo-slider-wrapper brand-logo-slider-wrapper--double-border">
                        <div class="ht-slick-slider" data-slick-setting='{
                            ...
                            <div class="single-brand-logo">
                                <a href="#">
                                    <img width="164" height="38" src="assets/img/brands/brand1.webp" class="img-fluid" alt="">
                                </a>
                            </div>
                            ...
                            <div class="single-brand-logo">
                                <a href="#">
                                    <img width="164" height="38" src="assets/img/brands/brand2.webp" class="img-fluid" alt="">
                                </a>
                            </div>
                            ...
                            <div class="single-brand-logo">
                                <a href="#">
                                    <img width="164" height="38" src="assets/img/brands/brand3.webp" class="img-fluid" alt="">
                                </a>
                            </div>
                            ...
                            <div class="single-brand-logo">
                                <a href="#">
                                    <img width="164" height="38" src="assets/img/brands/brand4.webp" class="img-fluid" alt="">
                                </a>
                            </div>
                            ...
                            <div class="single-brand-logo">
                                <a href="#">
                                    <img width="164" height="38" src="assets/img/brands/brand5.webp" class="img-fluid" alt="">
                                </a>
                            </div>
