...
<!-- Mirrored from htmldemo.net/alula/alula/shop-left-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Feb 2023 07:11:30 GMT -->
<head>
    <meta charset="utf-8">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-4 offset-lg-4 col-md-6">
                                    ...
                                    <div
                                        ...
                                        <div class="header-top-single-dropdown">
                                            <a href="javascript:void(0)" class="active-dropdown-trigger"
                                                id="language-options"> <img width="16" height="11" src="assets/img/icons/en-gb.webp" alt="">
                                                En-Gb <i class="ion-ios-arrow-down"></i></a>
                                            <!--=======  dropdown menu items  =======-->

                                            <div
                                                class="header-top-single-dropdown__dropdown-menu-items deactive-dropdown-menu">
                                                <ul>
                                                    <li><a href="#"> <img width="16" height="11" src="assets/img/icons/en-gb.webp" alt="">
                                                            English </a></li>
                                                    <li><a href="#"> <img width="16" height="11" src="assets/img/icons/de-de.webp" alt="">
                                                            Germany </a></li>
                                                </ul>
                                            </div>
                                        ...
                                        <div class="header-top-single-dropdown">
                                            <a href="javascript:void(0)" class="active-dropdown-trigger"
                                                id="currency-options">USD <i class="ion-ios-arrow-down"></i></a>
                                            <!--=======  dropdown menu items  =======-->
                        ...
                        <div class="navigation-top-search-area pt-25 pb-25">
                            <div class="row align-items-center">
                                <div class="col-6 col-xl-2 col-lg-3 order-1 col-md-6 col-sm-5">
                                    ...
                                    <div class="logo">
                                        <a href="index.html">
                                            <img width="141" height="40" src="assets/img/logo.webp" class="img-fluid" alt="">
                                        </a>
                                    </div>
                                        ...
                                        <div class="small-cart deactive-dropdown-menu">
                                            <div class="small-cart-item-wrapper">
                                                <div class="single-item">
                                                    <div class="image">
                                                        <a href="single-product.html">
                                                            <img width="90" height="90" src="assets/img/cart-image/small1-90x90.webp"
                                                                class="img-fluid" alt="">
                                                        </a>
                                                    </div>
                                                    <div class="content">
                                                        <p class="cart-name"><a href="single-product.html">Cillum
                                                                dolore</a></p>
                                                        <p class="cart-quantity"><span class="quantity-mes">1 x </span>
                                                            $78.80</p>
                                                    </div>
                                                ...
                                                <div class="single-item">
                                                    ...
                                                    <div class="image">
                                                        <a href="single-product.html">
                                                            <img width="90" height="90" src="assets/img/cart-image/small2-90x90.webp"
                                                                class="img-fluid" alt="">
                                                        </a>
                                                    </div>
                                                    <div class="content">
                                                        <p class="cart-name"><a href="single-product.html">Condimentum
                                                                posuere</a></p>
                                                        <p class="cart-quantity"><span class="quantity-mes">1 x </span>
                                                            $78.80</p>
                                                    </div>
                                        ...
                                        <ul class="mega-menu four-column">
                                            ...
                                            <li class="megamenu-banner d-none d-lg-block mt-30 w-100">
                                                <a href="shop-left-sidebar.html" class="mb-0">
                                                    <img width="1049" height="180" src="assets/img/banners/img-bottom-menu.webp" class="img-fluid"
                                                        alt="">
                                                </a>
                                            </li>
                                        </ul>
                    ...
                    <div class="page-sidebar">
                        ...
                        <div class="page-sidebar-banner">
                            <a href="shop-left-sidebar.html">
                                <img width="255" height="470" src="assets/img/banners/banner-sidebar.webp" class="img-fluid" alt="">
                            </a>
                        </div>
                        ...
                        <div class="shop-header__left">
                            <div class="grid-icons mr-20">
                                <button data-target="grid three-column" data-tippy="3" data-tippy-inertia="true"
                                    ...
                                    data-tippy-theme="sharpborder" class="active three-column"></button>
                                <button data-target="grid four-column" data-tippy="4" data-tippy-inertia="true"
                                    data-tippy-animation="fade" data-tippy-delay="50" data-tippy-arrow="true"
                                    data-tippy-theme="sharpborder" class="four-column d-none d-lg-block"></button>
                    ...
                    <div class="row shop-product-wrap grid three-column mb-10">
                        ...
                        <div class="col-12 col-lg-4 col-md-6 col-sm-6 mb-20">
                            ...
                            <div class="single-slider-product grid-view-product">
                                <div class="single-slider-product__image">
                                    <a href="single-product.html">
                                        <img width="600" height="600" src="assets/img/products/medium11.webp" class="img-fluid" alt="">
                                    </a>
                        ...
                        <div class="col-12 col-lg-4 col-md-6 col-sm-6 mb-20">
                            ...
                            <div class="single-slider-product grid-view-product">
                                <div class="single-slider-product__image">
                                    <a href="single-product.html">
                                        <img width="600" height="600" src="assets/img/products/medium12.webp" class="img-fluid" alt="">
                                    </a>
                        ...
                        <div class="col-12 col-lg-4 col-md-6 col-sm-6 mb-20">
                            ...
                            <div class="single-slider-product grid-view-product">
                                <div class="single-slider-product__image">
                                    <a href="single-product.html">
                                        <img width="600" height="600" src="assets/img/products/medium13.webp" class="img-fluid" alt="">
                                    </a>
                        ...
                        <div class="col-12 col-lg-4 col-md-6 col-sm-6 mb-20">
                            ...
                            <div class="single-slider-product grid-view-product">
                                <div class="single-slider-product__image">
                                    <a href="single-product.html">
                                        <img width="600" height="600" src="assets/img/products/medium14.webp" class="img-fluid" alt="">
                                    </a>
                        ...
                        <div class="col-12 col-lg-4 col-md-6 col-sm-6 mb-20">
                            ...
                            <div class="single-slider-product grid-view-product">
                                <div class="single-slider-product__image">
                                    <a href="single-product.html">
                                        <img width="600" height="600" src="assets/img/products/medium9.webp" class="img-fluid" alt="">
                                    </a>
                        ...
                        <div class="col-12 col-lg-4 col-md-6 col-sm-6 mb-20">
                            ...
                            <div class="single-slider-product grid-view-product">
                                <div class="single-slider-product__image">
                                    <a href="single-product.html">
                                        <img width="600" height="600" src="assets/img/products/medium8.webp" class="img-fluid" alt="">
                                    </a>
                        ...
                        <div class="col-12 col-lg-4 col-md-6 col-sm-6 mb-20">
                            ...
                            <div class="single-slider-product grid-view-product">
                                <div class="single-slider-product__image">
                                    <a href="single-product.html">
                                        <img width="600" height="600" src="assets/img/products/medium1.webp" class="img-fluid" alt="">
                                    </a>
                        ...
                        <div class="col-12 col-lg-4 col-md-6 col-sm-6 mb-20">
                            ...
                            <div class="single-slider-product grid-view-product">
                                <div class="single-slider-product__image">
                                    <a href="single-product.html">
                                        <img width="600" height="600" src="assets/img/products/medium2.webp" class="img-fluid" alt="">
                                    </a>
                            ...
                            <div class="col-lg-4 col-md-6">
                                ...
                                <div class="single-footer-widget">
                                    <div class="footer-logo mb-25">
                                        <img width="141" height="40" src="assets/img/logo-alula2.webp" class="img-fluid" alt="">
                                    </div>
                                    ...
                                    <div class="instagram-image-slider-wrapper">
                                        <div class="ht-slick-slider" data-slick-setting='{
                                            ...
                                            <div class="single-instagram-image">
                                                <a href="#"><img width="320" height="320" src="assets/img/instagram/a1.webp" class="img-fluid"
                                                        alt=""></a>
                                            </div>
                                            ...
                                            <div class="single-instagram-image">
                                                <a href="#"><img width="320" height="320" src="assets/img/instagram/a2.webp" class="img-fluid"
                                                        alt=""></a>
                                            </div>
                                            ...
                                            <div class="single-instagram-image">
                                                <a href="#"><img width="320" height="320" src="assets/img/instagram/a3.webp" class="img-fluid"
                                                        alt=""></a>
                                            </div>
                                            ...
                                            <div class="single-instagram-image">
                                                <a href="#"><img width="320" height="320" src="assets/img/instagram/a4.webp" class="img-fluid"
                                                        alt=""></a>
                                            </div>
                                            ...
                                            <div class="single-instagram-image">
                                                <a href="#"><img width="320" height="320" src="assets/img/instagram/a5.webp" class="img-fluid"
                                                        alt=""></a>
                                            </div>
                                            ...
                                            <div class="single-instagram-image">
                                                <a href="#"><img width="320" height="320" src="assets/img/instagram/a6.webp" class="img-fluid"
                                                        alt=""></a>
                                            </div>
                                            ...
                                            <div class="single-instagram-image">
                                                <a href="#"><img width="320" height="320" src="assets/img/instagram/a7.webp" class="img-fluid"
                                                        alt=""></a>
                                            </div>
                                            ...
                                            <div class="single-instagram-image">
                                                <a href="#"><img width="320" height="320" src="assets/img/instagram/a8.webp" class="img-fluid"
                                                        alt=""></a>
                                            </div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-6 text-center text-md-end">
                                <div class="payment-logo">
                                    <img width="286" height="23" src="assets/img/icons/payment.webp" class="img-fluid" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="big-image-slider-wrapper">
                                    <div class="ht-slick-slider big-image-slider" data-slick-setting='{
                                        ...
                                        <div class="big-image-slider-single-item">
                                            <img width="700" height="700" src="assets/img/products/big1-1.webp" class="img-fluid" alt="">
                                        </div>
                                ...
                                <div class="small-image-slider-wrapper small-image-slider-wrapper--quickview">
                                    <div class="ht-slick-slider small-image-slider" data-slick-setting='{
                                        ...
                                        <div class="small-image-slider-single-item">
                                            <img width="600" height="600" src="assets/img/products/small1-1.webp" class="img-fluid" alt="">
                                        </div>
                                        ...
                                        <div class="small-image-slider-single-item">
                                            <img width="600" height="600" src="assets/img/products/small1-2.webp" class="img-fluid" alt="">
                                        </div>
                                        ...
                                        <div class="small-image-slider-single-item">
                                            <img width="600" height="600" src="assets/img/products/small1-3.webp" class="img-fluid" alt="">
                                        </div>
                                        ...
                                        <div class="small-image-slider-single-item">
                                            <img width="600" height="600" src="assets/img/products/small1-4.webp" class="img-fluid" alt="">
                                        </div>
                                        ...
                                        <div class="small-image-slider-single-item">
                                            <img width="600" height="600" src="assets/img/products/small1-5.webp" class="img-fluid" alt="">
                                        </div>
                                        ...
                                        <div class="small-image-slider-single-item">
                                            <img width="600" height="600" src="assets/img/products/small1-6.webp" class="img-fluid" alt="">
                                        </div>
