                    ...
                    <div class="footer-content-wrapper border-top pt-40">
                        <div class="row">
                            <div class="col-lg-4 col-md-6">
                                ...
                                <div class="single-footer-widget">
                                    <div class="footer-logo mb-25">
                                        <img width="200" height="60" src="assets/img/ezone_footer_logo.png" class="img-fluid"
                                            alt="">
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-6 mt-md-30 mt-sm-30">
                                ...
                                <div class="single-footer-widget">
                                    <h5 class="montserrat-footer-widget-title">Popular Category</h5>
                            ...
                            <div class="col-lg-4 col-md-6 mt-md-30 mt-sm-30">
                                ...
                                <div class="single-footer-widget">
                                    <h5 class="montserrat-footer-widget-title">Pages </h5>
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-6 text-center text-md-start mb-sm-15">
                                <div class="copyright-text">
                                    <p>Copyright &copy; 2023 <a href="#">Ezonefly</a>. All Right Reserved. Developed By <a href="http://algoflow.in">Algoflow</a></p>
                                </div>
                            </div>
